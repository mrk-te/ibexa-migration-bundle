...
class GenerateTest extends CommandExecutingTest
{
    ...
    public function provideGenerateParameters()
    {
        $out = array(
            ...
            array('unit_test_generated_object_state_group', null, 'object_state_group', 'object_state_group_identifier', 'ibexa_lock'),
            array('unit_test_generated_object_state_group', 'yml', 'object_state_group', 'object_state_group_identifier', 'ibexa_lock', false, 'update'),
            array('unit_test_generated_object_state_group', 'json', 'object_state_group', 'object_state_group_identifier', 'ibexa_lock', false, 'delete'),
    ...
    protected function checkGeneratedFile($filePath, $mode)
    {
        ...
        $this->assertMatchesRegularExpression('?\| ' . basename($filePath) . ' +\| not executed +\|?', $output);
